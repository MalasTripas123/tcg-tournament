...
const tournamentSchema = new mongoose.Schema({
  ...
  gameFormatId: { type: String, default: '', trim: true },
  gameFormatName: { type: String, default: '', trim: true },
  locationId: { type: String, default: '', trim: true },
  location: { type: String, default: '', trim: true },
  locationLocality: { type: String, default: '', trim: true },
  locationRegion: { type: String, default: '', trim: true },
  locationCountry: { type: String, default: '', trim: true },
